...
#ifndef ELS_MBEDTLS_CONFIG_H
#define ELS_MBEDTLS_CONFIG_H
 ...
 *
 * Uncomment this macro in case AES CBC-MAC should be used with ELS CMAC command.
 *
 */
